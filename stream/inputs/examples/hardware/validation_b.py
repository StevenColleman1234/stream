...
from inputs.examples.hardware import validation_architecture_description as arch_des
...
multiplier_array = arch_des.multiplier_array_1D()
memory_hierarchy = arch_des.memory_hierarchy_validation_dataflow(multiplier_array)
...
core_5 = Core(4, multiplier_array, memory_hierarchy, dataflows)
core_6 = Core(5, multiplier_array, memory_hierarchy, dataflows)
core_7 = Core(6, multiplier_array, memory_hierarchy, dataflows)
core_8 = Core(7, multiplier_array, memory_hierarchy, dataflows)
#
...
from inputs.examples.hardware.cores.offchip_dual_port import get_offchip_core
...
simd_core = get_simd_core(id=8)
offchip_core_id = 8
offchip_core = get_offchip_core(id=offchip_core_id)

#cores_graph = get_2d_mesh([core_1, core_2, core_3, core_4, core_5, core_6, core_7, core_8], 1, 8, 8, 0,
#                          simd_core=simd_core, offchip_core=offchip_core)

cores_graph = get_2d_mesh([core_1, core_2, core_3, core_4, core_5, core_6, core_7, core_8], 1, 8, 8, 0,
                          offchip_core=offchip_core)

global_buffer = None
accelerator = Accelerator("Validation", cores_graph, global_buffer, offchip_core_id=offchip_core_id)
