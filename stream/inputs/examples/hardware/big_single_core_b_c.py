...
#
def get_dataflows():
    return [{'D1': ('B', 64), 'D2': ('C', 64)}]

multiplier_array = arch_des.multiplier_array_2D()
memory_hierarchy = arch_des.memory_hierarchy_B_C_dataflow(multiplier_array)
...
global_buffer = None
accelerator = Accelerator("Big_single_core_b_c", cores_graph, global_buffer, offchip_core_id=offchip_core_id)