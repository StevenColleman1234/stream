from inputs.examples.hardware.cores.testing_core1 import get_core as get_testing_core1
from inputs.examples.hardware.cores.testing_core2 import get_core as get_testing_core2
