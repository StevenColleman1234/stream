...
from inputs.examples.hardware import architecture_description_bigBWs as arch_des
...
global_buffer = None
accelerator = Accelerator("Big_single_core_b_k_bigBWs", cores_graph, global_buffer, offchip_core_id=offchip_core_id)