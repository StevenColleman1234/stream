...
from inputs.examples.hardware import small_architecture_definition3D as arch_def
from inputs.examples.hardware import small_architecture_description3D as arch_des
...
global_buffer = None
accelerator = Accelerator("Small_single_core_b_c_k", cores_graph, global_buffer, offchip_core_id=offchip_core_id)