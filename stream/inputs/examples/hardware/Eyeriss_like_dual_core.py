from inputs.examples.hardware.cores.pooling import get_array, get_memory_hierarchy
...
def cores():
    ...
    pooling_array = get_array()
    pooling_memory_hierarchy = get_memory_hierarchy(pooling_array)

    core1 = Core(1, multiplier_array1, memory_hierarchy1)
    core2 = Core(2, multiplier_array1, memory_hierarchy1)
    core3 = Core(3, pooling_array, pooling_memory_hierarchy)
...
cores = cores()
global_buffer = None
accelerator = Accelerator("Eyeriss-like-dual-core-with-pooling", cores, global_buffer)
