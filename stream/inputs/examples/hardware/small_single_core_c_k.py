...
from inputs.examples.hardware import small_architecture_description as arch_des
...
global_buffer = None
accelerator = Accelerator("Small_single_core_c_k", cores_graph, global_buffer, offchip_core_id=offchip_core_id)