...
#
def get_dataflows():
    return [{'D1': ('B', 8), 'D2': ('B', 8)}]

multiplier_array = arch_des.multiplier_array_2D()
memory_hierarchy = arch_des.memory_hierarchy_B_dataflow(multiplier_array)
...
global_buffer = None
accelerator = Accelerator("Small_single_core_b", cores_graph, global_buffer, offchip_core_id=offchip_core_id)