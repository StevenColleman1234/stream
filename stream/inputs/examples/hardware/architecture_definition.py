...
# 
# Size L2 SRAM weight:
size_l2_weights = 1048576  # (10*2**20)  # 9437184  # number of elements needed for last resnet18 layer   #  1048576
# Bus width L2 SRAM weight:
width_l2_weigths = 256*4
# Size L2 SRAM activation:
size_l2_activation = 1048576
# Bus width L2 SRAM activation:
width_l2_activation = 256*4
# Size L1 SRAM weight:
size_l1_weights = 16384*4*2
# Bus width L1 SRAM weight:
width_l1_weights = 128*4*2
# Size L1 SRAM activation:
size_l1_activation = 65536*2
# Bus width L1 SRAM activation:
width_l1_activation = 512*2
# 
###############################################################################################
# 
...
off_chip_memory = MemoryInstance(name="dram", size=1073741824*8, r_bw=256, r_port=0, w_port=0, rw_port=1, latency=1, use_cacti_automation=False)
