...
from inputs.examples.hardware import bigquad_architecture_definition as arch_def
from inputs.examples.hardware import bigquad_architecture_description as arch_des
...
global_buffer = None
accelerator = Accelerator("Bigquadcore_b_k", cores_graph, global_buffer, offchip_core_id=offchip_core_id)
