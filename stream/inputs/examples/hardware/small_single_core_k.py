...
#
def get_dataflows():
    return [{'D1': ('K', 8), 'D2': ('K', 8)}]

multiplier_array = arch_des.multiplier_array_2D()
memory_hierarchy = arch_des.memory_hierarchy_K_dataflow(multiplier_array)
...
global_buffer = None
accelerator = Accelerator("Small_single_core_k", cores_graph, global_buffer, offchip_core_id=offchip_core_id)
